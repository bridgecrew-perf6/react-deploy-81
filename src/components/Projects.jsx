...
export default function Projects(){
    ...
    return (
        ...
        <section className="container mx-auto">
          <h1 className="text-5xl text-sky-100 flex justify-center cursive mt-9 mb-6">My Projects</h1>
                    ...
                    >
                      ...
                      <span className="relative h-full flex justify-end items-end pr-4 pb-4">
                        <h4 className="text-sky-100 text-md font-bold px-3 py-4 bg-sky-600 rounded bg-opacity-80">
                          <span><a href={post.GitHub} target="_blank" rel="noreferrer" className="hover:text-sky-900 m-3">GitHub Repo</a></span>
                         <span> <a href={post.deployedLink} target="_blank" rel="noreferrer" className="hover:text-sky-900">Deployed Website</a></span>
                        </h4>
                      </span>
                    </span>
                </article>
